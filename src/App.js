...
import Sec2_2 from './component/Section2_right';
...
const  navbar = [{source:'https://www.docplanner.com/img/logo-default-group-en.svg?v=1',title:"hey"},
{title:'About Us'},{title :'Career'},{title :'Departments',submenu: ['Marketing & PR'
,'Customer Success & Sales','IT, Product , Data','Finance & Administration','HR & More']}]




function App() {
  const introduction = [  {alt: 'About us', }, {h1: "Making the healthcare experience more human"}, {p:"We want patients to find the perfect doctor and book an appointment in the most easy way. The patient journey should be enjoyable,  and that's why we are always next to them to help them find the best possible care. Anytime, anywhere."} ]
  const sec2 = [ {span: 'For patients'},
  {h2: "Find a doctor, book a visit and solve any health-related doubt"},
  {select: 'Choose country',  option: [{title:'choose country'},
                              {title:'Italy'},
                               {title:'Tunis'},
                               {title:'USA'},
                               {title:'Almagne'},]},
 ...
 const company = [
 {  href:  "https://www.znanylekarz.pl/?_ga=2.97693599.1461037084.1568126908-756919852.1568126908",
 svg: {   class: "doctor",
...
fill: " #00b39b",
 ...
 const sec4 = [
    {image: "https://www.docplanner.com/img/flag.png", h5:"Leader in 10 countries", p: "Poland, Turkey, Spain, Italy, Czech Republic, Mexico, Brazil, Colombia, Argentina and Chile ", marginT: "25px"},
     {image: "https://www.docplanner.com/img/visits.png", h5:"1.5 million appointments", p: "booked last month "},
     {image: "https://www.docplanner.com/img/patients.png", h5:"30 million unique patients", p: "visit us every month", marginT: "25px"},
     {image: "https://www.docplanner.com/img/doctors.png", h5:"2 million active doctors", p: "trust in our solutions"}
                          
                          
      ]
   const margin = {marginTop: "25px"}
   const destination = [
    { image:"https://www.docplanner.com/images/warsaw.png", p:"Warsaw"},
    { image:"https://www.docplanner.com/images/barcelona.png", p:"Barcelona"},
    { image:"https://www.docplanner.com/images/istanbul.png", p:"Istanbul"},
    { image:"https://www.docplanner.com/images/rome.png", p:"Rome"},
    { image:"https://www.docplanner.com/images/mexico-city.png", p:"Mexico City"},
    { image:"https://www.docplanner.com/images/curitiba.png", p:"Curritiba"}
  ...
  return (
    ...
    <section id="section2" class="container">
                <div class="left-card card-section2">  
                   <Sec2 card={sec2} image="https://www.docplanner.com/img/screen-marketplace@2x.png"/>
               </div>
               <div class="right-card card-section2">
                   <Sec2_2  span="For doctors" h2="Save time managing visits and cut no-shows by half" image="https://www.docplanner.com/img/screen-saas@2x.png"/>
               </div>
        </section>
        <Company image={company}/>
        <Sec4 mincard={sec4} style={margin}/>
        <section id="section5" class="container">
               <h5>Improve the lives of millions. <br/>Change yours forever</h5>
           ...
           <Destination worldcard={destination} />
           <footer>
